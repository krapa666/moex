...
Миграция `0015_reliable_volume_notifications` добавляет счётчики аномалий IMOEX, отправленных и подавленных уведомлений, а также числа бумаг с обновлённой историей для диагностики решения по широкому рынку и режима сбора.
...
- количество найденных аномалий, аномалий IMOEX, отправленных и подавленных уведомлений;
- количество бумаг, для которых в последнем запуске обновлялась история MOEX;
