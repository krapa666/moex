...
Тесты поднимают статический frontend на `127.0.0.1:4173`, подменяют API-ответы и проверяют 17-колоночную двухлетнюю таблицу в Chromium на ширинах от 1024 до 2560 пикселей. HTML-отчёт создаётся в `playwright-report/`.
